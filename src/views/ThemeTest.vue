  ...
  <main>
    ...
    <section class="bg-image-hero center-tablet dark overlay-hero">
      <div class="full-screen -margin-bottom middle padding padding-top-tablet">
        <div class="row max-width-l">
          ...
          <div class="col-one-half middle">
            <img :src="require('@/assets/media/content/hero-illustration.png')"  alt="Hero Illustration">
          </div>
        </div>
      </div>
      <div class="padding">
        <div class="row margin-bottom max-width-l">
          ...
          <div class="col-one-half">
            <img class="rounded shadow-l" :src="require('@/assets/media/content/editor.png')"  alt="Editor">
          </div>
        </div>
        <div class="row max-width-l reverse-order">
          <div class="col-one-half">
            <img class="rounded shadow-l" :src="require('@/assets/media/content/sketch.png')"   alt="Sketch">
          </div>
          <div class="col-one-half middle">
    ...
    <section class="bg-gradient-light -margin-bottom-2 overlay padding">
      ...
      <div class="margin-top max-width-l">
        <img class="rounded shadow-l" :src="require('@/assets/media/content/opalin-dashboard.png')"  alt="Opalin Dashboard">
      </div>
    </section>
      ...
      <div class="margin-top max-width-l">
        ...
        <div class="row min-two-columns">
          <div class="col-one-fourth">
            <img :src="require('@/assets/media/content/trusted-company-dark.png')"  alt="Trusted Company">
          </div>
          <div class="col-one-fourth">
            <img :src="require('@/assets/media/content/trusted-company-dark.png')"  alt="Trusted Company">
          </div>
        ...
        <img class="margin-top rounded shadow-l" :src="require('@/assets/media/content/customers.jpg')" alt="Customers">
      </div>
    </section>
